...
class TestDataSourceIntegration:
    ...
    @pytest.mark.skipif(
        os.environ.get(test_constants.SKIP_INTEGRATION_ENV_VAR, "true").lower() == "true",
    ...
    def test_real_yfinance_download(self) -> None:
        ...
        df = finance.get_ticker_data(test_constants.TestTickers.AAPL, force_download=True)
    ...
    def test_mock_yfinance_integration(self) -> None:
        ...
        with patch("yfinance.Ticker") as mock_ticker_class:
            ...
            df = finance.get_ticker_data(test_constants.TestTickers.TEST, force_download=True)
    ...
    def test_error_handling_integration(self) -> None:
        ...
        with patch("yfinance.Ticker") as mock_ticker_class:
            ...
            with pytest.raises(ConnectionError, match="Network error"):
                finance.get_ticker_data(test_constants.TestTickers.TEST, force_download=True)
    ...
    def test_cache_integration(
        ...
        with patch("yfinance.Ticker") as mock_ticker_class:
            ...
            df3 = finance.get_ticker_data(test_constants.TestTickers.TEST, force_download=True)
